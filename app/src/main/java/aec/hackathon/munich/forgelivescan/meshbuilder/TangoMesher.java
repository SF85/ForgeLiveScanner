...
package aec.hackathon.munich.forgelivescan.meshbuilder;
...
public class TangoMesher extends Tango.OnTangoUpdateListener 
    ...
    public Tango3dReconstruction mTango3dReconstruction = null;
    ...
    public Tango3dReconstructionConfig mConfig;
    ...
    private void setupReconstruction(SharedPreferences sharedPref){
        ...
        mConfig.putBoolean("use_space_clearing", true);  // Default: false
        mConfig.putBoolean("use_floorplan", false); // Default: false
    }
